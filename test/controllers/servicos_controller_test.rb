...
class ServicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servico" do
    assert_difference('Servico.count') do
      post servicos_url, params: { servico: { descricao: @servico.descricao, item: @servico.item, tipo_servico_id: @servico.tipo_servico_id, unidade_id: @servico.unidade_id } }
    end
  ...
  test "should update servico" do
    patch servico_url(@servico), params: { servico: { descricao: @servico.descricao, item: @servico.item, tipo_servico_id: @servico.tipo_servico_id, unidade_id: @servico.unidade_id } }
