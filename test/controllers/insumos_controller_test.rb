...
class InsumosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create insumo" do
    assert_difference('Insumo.count') do
      post insumos_url, params: { insumo: { codigo: @insumo.codigo, codigo_seinfra: @insumo.codigo_seinfra, descricao: @insumo.descricao, unidade_id: @insumo.unidade_id } }
    end
  ...
  test "should update insumo" do
    patch insumo_url(@insumo), params: { insumo: { codigo: @insumo.codigo, codigo_seinfra: @insumo.codigo_seinfra, descricao: @insumo.descricao, unidade_id: @insumo.unidade_id } }
